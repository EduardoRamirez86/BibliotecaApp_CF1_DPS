        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoLibro = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    StockTotal = table.Column<int>(type: "int", nullable: true),
                    StockPrestado = table.Column<int>(type: "int", nullable: true),
                    UbicacionEstante = table.Column<string>(type: "nvarchar(max)", nullable: true),
